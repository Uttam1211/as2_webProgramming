            ...
            <thead>
                ...
                <?php foreach($jobs as $job): ?>
                    <tr>
                        ...
                        <td><?php echo ($job->is_archived ==1)? 'Archived' : 'Active'; ?></td>
                        <td>
                            ...
                            <?php if (
                                ...
                                <form action="/admin/jobs/archive" method="post">
                                    ...
                                    <input type="submit" style="margin-bottom: 0.25em;" name="submit" value="<?php echo ($job->is_archived==1 )? 'Un-archive' : 'Archive'; ?>" />
                                </form>
                            <?php endif; ?>
